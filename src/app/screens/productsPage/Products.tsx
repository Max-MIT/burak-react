        ...
        <Container className={"brands-container"}>
          ...
          <Stack className="brand-wrapper">
            <Stack className="brand-card">
              <img src="img/doner.webp" className="brand-img" alt="doner" />
            </Stack>
            <Stack className="brand-card">
              <img src="img/seafood.webp" className="brand-img" alt="seafood" />
            </Stack>
            <Stack className="brand-card">
              <img src="img/sweets.webp" className="brand-img" alt="sweets" />
            </Stack>
            <Stack className="brand-card">
              <img src="img/gurme.webp" className="brand-img" alt="gurme" />
            </Stack>
          </Stack>
        </Container>
      </div>
